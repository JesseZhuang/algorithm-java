...
//    Test.assertMPEqual("easy.ImplementStrStr", "RabinKarpMC", inputs, expected);
    ...
    public int strStrKMP(String haystack, String needle) {
        ...
        return new KMP1D(needle).search(haystack);
    }
    ...
    public int strStrKMPDFA(String haystack, String needle) {
        ...
        if (needle.isEmpty()) return 0;// "a" "" expected 0
        KMP kmp = new KMP(needle.toCharArray(), 128);
        int res = kmp.search(haystack);
