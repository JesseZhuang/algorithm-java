...
/*
 *  Compilation:  javac WeightedQUHeightHalfPC.java
 *  Execution:    java WeightedQUHeightHalfPC < input.txt
 *  Dependencies: StdIn.java StdOut.java
 *  Data files:   https://algs4.cs.princeton.edu/15uf/tinyUF.txt
 *                https://algs4.cs.princeton.edu/15uf/mediumUF.txt
 *                https://algs4.cs.princeton.edu/15uf/largeUF.txt
 *
 *  Weighted quick-union by height with path compression by halving.
 *
 *  % java WeightedQUHeightHalfPC < tinyUF.txt
 *  4 3
 *  3 8
 *  6 5
 *  9 4
 ...
 * p>
 * This implementation uses <em>weighted quick union by height</em>
...
public class WeightedQUHeightHalfPC {

    private int[] parent;  // parent[i] = parent of i
    private byte[] height;   // height[i] = height of subtree rooted at i (never more than 31)
     ...
     */
    public WeightedQUHeightHalfPC(int n) {
    ...
    public void union(int p, int q) {
        ...
        // make root of smaller height point to root of larger height
    ...
    public static void main(String[] args) {
        int n = StdIn.readInt();
        WeightedQUHeightHalfPC uf = new WeightedQUHeightHalfPC(n);
        while (!StdIn.isEmpty()) {
            int p = StdIn.readInt();
            int q = StdIn.readInt();
