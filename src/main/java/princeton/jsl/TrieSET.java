...
/**
 * Implement with ArrayDeque instead. Make get public. Added one API.
 */
public class TrieSET implements Iterable<String> {
    ...
    /**
     * Whether the String input is a prefix for at least one of the words in this Trie.
     *
     * @param prefix string input to check.
     * @return the boolean result.
     */
    public boolean isAPrefix(String prefix) {
        if (prefix == null) throw new IllegalArgumentException("argument cannot be null");
